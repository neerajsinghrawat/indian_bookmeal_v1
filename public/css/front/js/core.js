    ...
    function (e, t, n) {
        ...
        !(function (t, n) {
            ...
            var S = (function (e) {
                ...
                try {
                    j.apply((O = I.call(x.childNodes)), x.childNodes), O[x.childNodes.length].nodeType;
                } catch (e) {
                    j = {
                        apply: O.length
                            ? function (e, t) {
                ...
                C.each(
                    ...
                    function (e, t) {
                        C.fn[e] = function (n, i) {
                            ...
                            return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (o = C.filter(i, o)), this.length > 1 && (P[e] || C.uniqueSort(o), I.test(e) && o.reverse()), this.pushStack(o);
                        };
                    }
                );
            var M = /[^\x20\t\r\n\f]+/g;
                    ...
                    ajax: function (e, t) {
                        ...
                        f.hasContent
                            ...
                            : ((p = f.url.slice(o.length)),
                              ...
                              !1 === f.cache && ((o = o.replace(It, "$1")), (p = (Et.test(o) ? "&" : "?") + "_=" + St.guid++ + p)),
                              (f.url = o + p)),
                        ...
                        t.$el.length &&
                            o.load().then(function (n) {
                                t.$el.each(function () {
                                    ...
                                    new n.maps.Marker({ position: i, map: o, icon: { url: "assets/img/location-pin.png", anchor: new n.maps.Point(29, 64), size: new n.maps.Size(72, 72), scaledSize: new n.maps.Size(72, 72) } });
                                    o.panTo(i);
                                });
                            });
                    },
                                ...
                                if (g)
                                    for (; P < N; )
                                        I.push({
                                            ...
                                            time: $[P].textContent,
                                            timestamp: $[P].getAttribute("datetime")
                                                .replace("+0000", "Z")
                                    ...
                                    for (; P < N; ) {
                                        if ("string" != typeof a) {
                                            var L = $[P].getAttribute("datetime"),
                                                ...
                                                H = a(M, L);
                                            if (($[P].setAttribute("aria-label", H), S[P].textContent))
                                                if (l) $[P].textContent = H;
                                                else {
                                                    var R = document.createElement("p"),
                                                        q = document.createTextNode(H);
                                                    R.appendChild(q), R.setAttribute("aria-label", H), ($[P] = R);
                                                }
                                        ...
                                        if (
                                            (n
                                                ? (h && (b(S[P]), s && b(E[P])),
                                                  ...
                                                  r && (F += m ? '<p class="timePosted"><a href="' + D[P] + '">' + $[P].getAttribute("aria-label") + "</a></p>" : '<p class="timePosted">' + $[P].getAttribute("aria-label") + "</p>"))
                                                : (S[P].textContent,
                                            ...
                                            for (var z = x(_[P]), B = 0; B < z.length; B++) F += '<div class="media"><img src="' + z[B] + '" alt="Image from tweet" /></div>';
                                        (p || (!p && S[P].textContent.length)) && I.push(F), P++;
                                    }
                                !(function (t) {
                                    if (null === d) {
        ...
        n.r(t),
            function (e) {
                ...
                var t = n(15),
                    ...
                    y = n(29);
                e(function () {
                    o.a.init(), i.a.init(), r.a.init(), s.a.init(), a.a.init(), l.a.init(), c.a.init(), d.a.init(), u.a.init(), p.a.init(), f.a.init(), h.a.init(), t.a.init(), m.a.init(), g.a.init(), v.a.init(), y.a.init();
                }),
