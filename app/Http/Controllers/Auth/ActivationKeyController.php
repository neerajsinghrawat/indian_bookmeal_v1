    ...
    public function activateKey($activation_key)
    {
        ...
        if (Auth::check()) {
            if (auth()->user()->activated) {
                Session::flash('success','Your email is already activated.');
        ...
        if (empty($activationKey)) {
            ...
            Session::flash('warning','The provided activation key appears to be invalid.');
            return redirect()->route('login')
        ...
        Session::flash('success','You successfully activated your email! You can now login.');
