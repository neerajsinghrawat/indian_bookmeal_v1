      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="{{ route('admin.openHours.add.post') }}" enctype="multipart/form-data" method="POST" >
             {{ csrf_field() }}
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div style="margin-left: 10px;"> <b> Time</b> <input type="radio" name="type" class="radio_button" value="time" required="required" checked="checked">

                  <b style="margin-left: 10px;">Closed </b> <input type="radio" name="type" class="radio_button" value="closed" required="required" >

                  <b style="margin-left: 10px;">Custom text </b> <input type="radio" name="type" class="radio_button" value="custom_text"  required="required" >
                </div>
...
<?php $timearray=array('12:00  AM','12:30  AM','01:00  AM','01:30  AM','02:00 AM','02:30 AM','03:00 AM','03:30 AM','04:00 AM','04:30 AM','05:00 AM','05:30 AM','06:00 AM','06:30 AM','07:00 AM','07:30 AM','08:00 AM','08:30 AM','09:00 AM','09:30 AM','10:00 AM','10:30 AM','11:00 AM','11:30 AM','12:00 PM','12:30 PM','01:00 PM','01:30 PM','02:00 PM','02:30 PM','03:00 PM','03:30 PM','04:00 PM','04:30 PM','05:00 PM','05:30 PM','06:00 PM','06:30 PM','07:00 PM','07:30 PM','08:00 PM','08:30 PM','09:00 PM','09:30 PM','10:00 PM','10:30 PM','11:00 PM','11:30 PM');  ?>
                ...
                <div class="form-group custom_text" style="display: none;">
                  ...
                  <input type="text" class="form-control ct" name="text" placeholder="Enter Custom text">
                </div>
