...
<!-- 
                <div class="form-group">
                  ...
                  <b style="margin-left: 10px;">Main </b> <input type="radio" name="main" class="radio_button" value="main" {{ ($postcodes['main'] == '1')?'checked=checked':'' }} required="required" >
                </div>
                ...
                <div class="form-group selectfranchise" style="<?php echo ($postcodes['main'] == 1)?'display: none':''; ?>">
