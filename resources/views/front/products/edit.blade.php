             ...
             {{ csrf_field() }}
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="model_no"  placeholder="Enter Model Number" required="required" value="{{ $products['model_no'] }}">
                ...
                <div class="form-group">
                 ...
                 <select class="form-control" name="stock_status">
                        @foreach($status as $key => $statu)
                            <option class="selectcategory" value="{{ $key }}"{{ ($products['stock_status'] == $key)?'selected':'' }}>{{ ucwords($statu) }}</option>
                        @endforeach
                    </select>
                  ...
                  <label for="exampleInputEmail1"> Country of Manufacture</label>
                    ...
                    <select class="form-control" name="country_id">
                        @foreach($country_list as $country)
                            ...
                            <option value="{{ $country->id }}" {{ ($products['country_id'] == $country->id)?'selected':'' }}>{{ ucwords($country->country_name) }}</option>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <textarea class="form-control" id="editor1" name="short_description">{{ $products['short_description'] }}</textarea>
                 ...
                 <div class="form-group">
                  ...
                  <textarea class="form-control" id="editor2" name="description">{{ $products['description'] }}</textarea>                 
