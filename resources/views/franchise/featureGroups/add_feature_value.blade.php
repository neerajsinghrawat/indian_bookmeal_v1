...
$(document).ready(function() {
  ...
  $(document).on('click','.add_image',function(){
    //alert('baseUrl');
     ...
     $(".attachment_fields").append('<div class="form-group"><i class="fa fa-close deleteCurrentRow_1" style="cursor:pointer;color: #d33b3b;float:right;"/></i><input type="text" class="form-control" name="value[]" required="required" placeholder="Enter Value"></div>');
