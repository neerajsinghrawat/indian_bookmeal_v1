            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="{{ route('staff.logout') }}" class="btn btn-default btn-flat"
                                            onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">
                                            Logout
                                        </a>
          
      <form id="logout-form" action="{{ 'App\Models\Staff' == Auth::getProvider()->getModel() ? route('staff.logout') : route('logout') }}" method="POST" style="display: none;">
          {{ csrf_field() }}
         </form>
                </div>
              </li>
...
<?php 
    ...
    ?>
        ...
        <li class="{{ ((!empty($controller_name)) && ($controller_name == 'orders'))?'active':'' }}">
          <a href="{{ URL::to('staff/orders') }}">
            <i class="fa fa-bars" aria-hidden="true"></i><span>Order List</span>          
          </a>
